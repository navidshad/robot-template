...
var mstr = {
    ...
    btns: {
        ...
        backbtn: '' + 'دکمه های برگشت',
        backbtn_back: '🔙 برگشت به ' + 'دکمه های برگشت',
    ...
    mess : {
        ...
        getbackName: 'لطفا نام دکمه برگشت را وارد کنید، علامت زیر باید حتما در نام مورد نظر وجود داشته باشد: \n 🔙',
        getcatid:'لطفا ای دی دسته بندی که میخواهید دکم برگشت در آن قرار بگیرد را وارد کنید.',
